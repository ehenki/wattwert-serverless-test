...
def download_LOD2(utm_easting, utm_northing):
    ...
    # 2) Build Thüringen-specific download URL and filename
    downloadurl = (
        f"https://geoportal.geoportal-th.de/3dgebaeude/LoD2/LoD2_32_{coord1}_{coord2}_2_TH.zip"
    )
    filename = f"Thüringen_{coord1}_{coord2}.zip"
    ...
    if os.path.exists(zipfile_path):
        ...
        if age < one_year:
            ...
            return _unpack_Thüringen_gml(zipfile_path, LOD2_path)
        else:
...
def _unpack_Thüringen_gml(zip_path, out_dir):
    """Extract first .gml from a Thüringen ZIP archive to out_dir."""
