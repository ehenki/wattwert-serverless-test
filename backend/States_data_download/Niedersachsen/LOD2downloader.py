...
def download_LOD2(utm_easting, utm_northing):
    ...
    # Build URL
    downloadurl = f"https://lod2.s3.eu-de.cloud-object-storage.appdomain.cloud/LoD2_32_{coord1}_{coord2}_1_ni.gml"
    filename = f"niedersachsen_{coord1}_{coord2}.gml"
