# Downloads LOD2 file for Niedersachsen
import os
import time
import requests
...
def download_laser(utm_easting, utm_northing):
    ...
    # Build URL
    downloadurl = f"https://www.opengeodata.nrw.de/produkte/geobasis/hm/3dm_l_las/3dm_l_las/3dm_32_{coord1}_{coord2}_1_nw.laz"
    filename = f"nrw_{coord1}_{coord2}.laz"
    ...
    # Return the path to the .laz file
    return file_path
