...
def download_LOD2(utm_easting, utm_northing):
    ...
    # Build URL
    downloadurl = f"https://www.opengeodata.nrw.de/produkte/geobasis/3dg/lod2_gml/lod2_gml/LoD2_32_{coord1}_{coord2}_1_NW.gml"
    filename = f"nrw_{coord1}_{coord2}.gml"
